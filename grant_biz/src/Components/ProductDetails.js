...
const renderProductsList = product.doc((product1, index) => {
    const { title, store_name, description, price, store_avatar, image, type, rate,id  } =product1;
    console.log("123098",product1)
    return (
        <div className="" key={index}>
           <Link to={`/product/${id}`}> 
            <div className="">
