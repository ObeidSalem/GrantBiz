  ...
  return (
    <div className="fixed bottom-0 w-full bg-white border border-gray-200 m-only">
      <div className="flex items-center justify-center w-screen space-x-0">
        <NavLink className="text-black py-3 text-sm text-center active:text-primary w-20" to="/GrantBiz/" onClick={handleClick}>
          <IoHomeOutline className="text-black h-6 w-full active:text-primary" />
          Home
        </NavLink>
        <NavLink className="text-black py-3 text-sm text-center active:text-primary w-20" to={`/GrantBiz/Feed`} onClick={handleClick}>
          <IoPlayCircleOutline className="text-black h-6 w-full active:text-primary" /> 
          Feed
        </NavLink>
        <NavLink className="text-black py-3 text-sm text-center active:text-primary w-20" to="/GrantBiz/Order" onClick={handleClick}>
          <IoChatbubblesOutline className="text-black h-6 w-full active:text-primary" />
          Order
        </NavLink>
        <NavLink className="text-black py-3 text-sm text-center active:text-primary w-20" to="/GrantBiz/Cart" onClick={handleClick}>
          <IoCartOutline className="text-black h-6 w-full active:text-primary" />
          Cart
        </NavLink>
        <NavLink className="text-black py-3 text-sm text-center active:text-primary w-20" to={`/GrantBiz/MyShop/${email}`} onClick={handleClick}>
