...
export default function Signup() {
  ...
  const [ErrorMatricNumber, setErrorMatricNumber] = useState("");
  ...
  async function handleSubmit(newUser) {
    try {
      ...
      // let isValidMatric = /^\d+$/.test(matricNumber);
      // // console.log ("hi",matricNumber.valueOf(7) = 7)
      // if (!isValidMatric && matricNumber.value.length === 7) {
      //   setErrorMatricNumber("please put a valid matric number for eg. 1726xxx");
      // }
    ...
    <>
      <div>
        <div className="flex justify-center  flex-col items-center min-h-screen pt-6 mx-6 sm:justify-center sm:pt-0 bg-background">
          <div className="w-full px-6 py-4 overflow-hidden bg-white border border-primary  shadow-md sm:max-w-md rounded-lg">
            ...
            <form>
              ...
              <div className="flex items-center justify-end mt-4">
                ...
                <div
                  ...
                  className="inline-flex items-center cursor-pointer px-4 py-2 ml-4 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-gray-900 border border-transparent rounded-md active:bg-gray-900 false"
                >
                  Register
                </div>
              </div>
