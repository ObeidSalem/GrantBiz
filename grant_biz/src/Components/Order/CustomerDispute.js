...
function CustomerDispute() {
  ...
  /////////////////////////////////////////////////////////////////
  const DisputesRef = collection(db, "CustomerDisputes");
  ...
  const [type, setType] = useState('Failed to Deliver The Product');
              ...
              <div className="">
                ...
                <div className="flex flex-col items-start border-solid border-black ">
                  ...
                  >
                    ...
                    <option value="Failed to Deliver The Product">Failed to Deliver The Product</option>
