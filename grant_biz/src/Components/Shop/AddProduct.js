...
import { onSnapshot, collection, doc, setDoc, getDocs, getDoc, query, where, updateDoc } from "firebase/firestore"
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex flex-row items-center">
                                ...
                                /><label className="block ml-2 text-sm font-medium text-gray-700 undefined">Cash on Delivery</label>
                            </div>
                            <div className="flex flex-row items-center">
                                <input
                                    type="checkbox"
                                ...
                                /><label className="block ml-2 text-sm font-medium text-gray-700 undefined">QR Code</label>
                            </div>
                        </div>
                        {QRCode &&
                            <>
